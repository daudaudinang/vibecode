...
- `phase-XX-*.md` nếu có
- `.claude/plans/PLAN_<NAME>/manifests/ownership.json` nếu có
- `.claude/plans/PLAN_<NAME>/manifests/dependency-graph.json` nếu có
...
Pipeline output:
- `.claude/pipeline/PLAN_<NAME>/02-review-plan.output.md`
- `.claude/pipeline/PLAN_<NAME>/02-review-plan.output.contract.json`
