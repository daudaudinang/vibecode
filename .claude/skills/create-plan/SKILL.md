...
- `.claude/pipeline/PLAN_<NAME>/01-create-plan.output.contract.json`
...
- Không dùng layout cũ `.claude/plans/PLAN_<NAME>.md`
- Luôn ghi pipeline output vào `.claude/pipeline/`
