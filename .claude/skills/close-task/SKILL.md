...
> **Full task guide**: `.claude/skills/tasks/close-task/TASK.md`
...
When Main Chat receives `/close-task`, spawn subagent with:
- Task file: `.claude/skills/tasks/close-task/TASK.md`
