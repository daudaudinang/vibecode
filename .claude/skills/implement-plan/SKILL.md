...
- `.claude/plans/PLAN_<NAME>/plan.md` hoặc `phase-XX-*.md`
- `.claude/plans/PLAN_<NAME>/manifests/ownership.json`
- `.claude/plans/PLAN_<NAME>/manifests/dependency-graph.json` nếu plan parallel-ready
...
- `.claude/pipeline/PLAN_<NAME>/03-implement-plan.output.contract.json`
