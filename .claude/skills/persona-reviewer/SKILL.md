...
> **Full task guide**: `.claude/skills/tasks/persona-review/TASK.md`
...
> Source of truth cho canonical review flow: `.claude/skills/review-plan/SKILL.md`, `.claude/skills/review-implement/SKILL.md`, `.claude/skills/lp-pipeline-orchestrator/SKILL.md`
