...
> **Full task guide**: `.agents/skills/tasks/debug-investigator/TASK.md`
...
When Orchestrator receives `/lp:debug-investigator` (canonical) or `/debug` (legacy alias), invoke agent (via `@agent-name`) with:
- Task file: `.agents/skills/tasks/debug-investigator/TASK.md`
