...
Bạn là **Task Closure Subagent** được spawn bởi orchestrator (parent agent). Nhiệm vụ: commit code changes, transition Jira ticket to Done, log work, và capture lessons learned.
...
- Human report: `.codex/pipeline/<PLAN_NAME>/06-close-task.output.md`
- Machine contract: `.codex/pipeline/<PLAN_NAME>/06-close-task.output.contract.json`
...
- Đọc và thực thi flow của `.agents/skills/lesson-capture/SKILL.md`
...
Constraints chi tiết nằm trong `.agents/skills/lesson-capture/SKILL.md`.
...
1. Human report: `.codex/pipeline/<PLAN_NAME>/06-close-task.output.md`
2. Machine contract: `.codex/pipeline/<PLAN_NAME>/06-close-task.output.contract.json`
