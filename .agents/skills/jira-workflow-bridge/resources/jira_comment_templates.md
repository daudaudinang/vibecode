...
📋 **Plan:** `PLAN_<NAME>`
📍 **Location:** `.codex/plans/PLAN_<NAME>/plan.md`
...
---
⏩ **Next:** Review artifact trong `.codex/pipeline/PLAN_<NAME>/01-create-plan.output.md`, sau đó tiếp tục LP delivery flow khi phù hợp.
```
...
- `.codex/pipeline/PLAN_<NAME>/05-qa-automation.output.md`
...
Template tham chiếu: `.agents/skills/jira-workflow-bridge/resources/jira_task_templates.md`
```
...
2. Ưu tiên nhắc `.codex/` artifact paths
